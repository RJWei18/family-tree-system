...
export const MainLayout: React.FC<MainLayoutProps> = ({ children, currentView, onViewChange }) => {
      ...
      >
           ...
           >
              ...
              <div className="mt-auto p-6 border-t border-slate-100">
                  <p className="text-xs text-slate-400 text-center">Version 1.0.4</p>
              </div>
           </div>
      </div>
  ) : null;
  ...
  return (
    <div className="flex flex-col md:flex-row w-full h-full bg-[var(--bg-main)] text-[var(--text-main)] font-sans overflow-hidden">
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex w-64 glass-panel m-4 flex-col p-5 gap-6 border-r-0 shrink-0 bg-white/60">
        <div className="px-2">
            <h1 className="text-2xl font-bold heading-gradient mb-1">
            FamilyConnect
            </h1>
            <p className="text-xs text-slate-500">家族系譜管理系統</p>
        </div>
