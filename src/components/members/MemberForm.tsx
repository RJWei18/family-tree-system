            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-5">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-500 mb-2 ml-1">職業 / 頭銜</label>
                    <input className="input-field py-2.5 text-slate-800 bg-slate-50 border-slate-200 focus:bg-white" value={formData.jobTitle || ""} onChange={e => setFormData({ ...formData, jobTitle: e.target.value })} placeholder="例如: 工程師, 學生..." />
                  </div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-500 mb-2 ml-1">過世原因</label>
                    <input className="input-field py-2.5 text-slate-800 bg-slate-50 border-slate-200 focus:bg-white" value={formData.deathReason || ''} onChange={e => setFormData({ ...formData, deathReason: e.target.value })} placeholder="選填" />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-slate-500 mb-2 ml-1">備註</label>
                    <textarea
                      className="input-field py-2.5 text-slate-800 bg-slate-50 border-slate-200 focus:bg-white min-h-[80px]"
